package mds.framework.example.views;
...
import mds.framework.example.views.MenuBar.MenuBarView;
import mds.framework.example.views.Message.MessagesBasic;
import mds.framework.example.views.empty.EmptyView;
import mds.framework.example.views.helloworld.HelloWorldView;
import mds.framework.example.views.list.ListView;
import com.vaadin.flow.component.button.Button;
import mds.framework.example.views.masterdetail.MasterDetailView;
...
public class MainLayout extends AppLayout {
  ...
  //  private final SecurityService securityService;
    ...
    public MainLayout(IDataService dataService) {
